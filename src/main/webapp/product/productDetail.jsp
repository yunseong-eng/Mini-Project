...
<body>
	...
	<div id="productDetail">
		<div id="history"><a href="${pageContext.request.contextPath }/index.do">Home</a> / <a href="${pageContext.request.contextPath }/product/productListForm.do?ctg=${dto.ctg }">${dto.ctg }</a></div>
		
		<div class="img">
			<img alt="상품이미지" src="../image/${dto.product_image }" id="img">
		</div>
		...
		<div class="productDetail">
			...
			<div id="name">${dto.product_name }</div>
			<div id="price"><fmt:formatNumber pattern="#,###" value="${dto.product_price }"/> 원<br></div>				
	...
	<div id="review">
		<div>리뷰 (${dto.reply})</div>
		<div class="review">
			<div class="name">신짱구</div>
			<div class="content">
